...
if 'continue_button_clicked' not in st.session_state:
    st.session_state.continue_button_clicked = False

if search_button and keyword:
    # Call the search function
    results = search_subtitles(keyword)
    
    if len(results) > 20 and not st.session_state.continue_button_clicked:
    ...
    elif results or st.session_state.continue_button_clicked:
